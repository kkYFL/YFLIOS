...
-(UIView *)itemsView{
    if (!_itemsView) {
        ...
        [button setTitle:[AppDelegate getURLWithKey:@"XuexiQingkuang"] forState:UIControlStateNormal];
        ...
        [button1 setTitle:[AppDelegate getURLWithKey:@"RenWujianjie"] forState:UIControlStateNormal];
        ...
        [button2 setTitle:[AppDelegate getURLWithKey:@"DangYuanHeart"] forState:UIControlStateNormal];
