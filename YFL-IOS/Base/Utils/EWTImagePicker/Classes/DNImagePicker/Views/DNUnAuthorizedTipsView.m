...
- (UIImageView *)imageView
{
    if (_imageView == nil) {
        ...
        _imageView.image = [[UIImage imageWithContentsOfFile:[[NSBundle EWTImagePickerBundle] pathForResource:@"image_unAuthorized" ofType:@"png"]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
