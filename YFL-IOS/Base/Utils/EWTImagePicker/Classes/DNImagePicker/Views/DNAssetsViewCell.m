...
- (void)fillWithAsset:(ALAsset *)asset isSelected:(BOOL)seleted
{
    ...
    if (thumbnailImageRef) {
        ...
        self.imageView.image = [[UIImage imageWithContentsOfFile:[[NSBundle EWTImagePickerBundle] pathForResource:@"assets_placeholder_picture" ofType:@"png"]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    }
}
...
- (void)updateCheckImageView
{
    if (self.checkButton.selected) {
        ...
        self.checkImageView.image = [[UIImage imageWithContentsOfFile:[[NSBundle EWTImagePickerBundle] pathForResource:@"icon_list_checkbox_abled" ofType:@"png"]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
        ...
        self.checkImageView.image = [[UIImage imageWithContentsOfFile:[[NSBundle EWTImagePickerBundle] pathForResource:@"icon_list_checkbox_disabled" ofType:@"png"]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
    }
}
