...
-(void)tabBarViewInit{
    ...
    EWTBaseNavigationController *fabuNav = [self viewControllerWithTitle:[AppDelegate getURLWithKey:@"zhibu"] image:[UIImage imageNamed:@"danghui"] selectedImage:[UIImage imageNamed:@"danghui"] VC:fabuVC];
