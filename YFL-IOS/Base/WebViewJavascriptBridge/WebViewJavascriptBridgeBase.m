...
- (void)injectJavascriptFile:(BOOL)shouldInject {
    ...
    if (shouldInject) {
        NSBundle *bundle = [NSBundle bundleForClass:[WebViewJavascriptBridgeBase class]];
        NSString* filePath = [bundle pathForResource:@"EWTBase" ofType:@"bundle"];
        NSBundle *fileBundle = [NSBundle bundleWithPath:filePath];
        filePath = [fileBundle pathForResource:@"EWTBase" ofType:@"bundle"];
        NSBundle *resourceBundle = [NSBundle bundleWithPath:filePath];
        NSString* path = [resourceBundle pathForResource:@"WebViewJavascriptBridge.js" ofType:@"txt"];
