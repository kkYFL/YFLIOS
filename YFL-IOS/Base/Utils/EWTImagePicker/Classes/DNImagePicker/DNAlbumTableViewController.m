...
//                                 action:@selector(cancelAction:)];
    NAVIGATION_BAR_RIGHT_BUTTON_ONLYTEXT(0, 0, 37, 25, NSLocalizedString(@"quxiao", nil), NSLocalizedString(@"quxiao", nil), cancelAction);
...
-(void)viewDidLayoutSubviews {
    self.tableView.frame = CGRectMake(0, NAVIGATION_BAR_HEIGHT, SCREEN_WIDTH, SCREEN_HEIGHT - NAVIGATION_BAR_HEIGHT);
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    imageFlowViewController.maxImagesCount = self.maxImagesCount;
