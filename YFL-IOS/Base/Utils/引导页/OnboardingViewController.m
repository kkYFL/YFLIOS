...
static CGFloat const kBackgroundMaskAlpha = 1.0;
...
- (void)generateView {
    ...
    if (self.shouldMaskBackground) {
        ...
        backgroundMaskView.backgroundColor = [UIColor colorWithWhite:1.0 alpha:kBackgroundMaskAlpha];
    ...
    self.pageControl=[[RYPageControl alloc]initWithFrame:CGRectMake(0, CGRectGetMaxY(self.view.frame) - self.underPageControlPadding - kPageControlHeight, self.view.frame.size.width, kPageControlHeight) currentColor:[UIColor blackColor] nextColor:[UIColor colorWithRed:255 green:245 blue:0 alpha:1.0f] rsize:5];
