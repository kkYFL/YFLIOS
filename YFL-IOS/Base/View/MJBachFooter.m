...
@interface MJBachFooter ()
@property (weak, nonatomic) UILabel *label;
@property (weak, nonatomic) UIImageView *logo;
@end
@implementation MJBachFooter
...
- (void)prepare
{
    ...
    // logo
    UIImageView *logo = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"pullrefresh_default_ptr_up"]];
...
- (void)setState:(MJRefreshState)state
{
    ...
    switch (state) {
        case MJRefreshStateIdle:
        {
            ...
            self.logo.image = [UIImage imageNamed:@"pullrefresh_default_ptr_flip"];
        ...
        {
            [self.logo.layer removeAnimationForKey:@"Animation"];
...
- (void)startRotateAnimation:(UIImageView *)theimg
{
    ...
    [theimg.layer addAnimation:animation forKey:@"Animation"];
}
