//
//  NewsPolicyDetailViewController.m
//  YFL-IOS
//
...
@interface NewsPolicyDetailViewController ()

@end

@implementation NewsPolicyDetailViewController
...
-(void)initView{
    self.title = NSLocalizedString(@"XiangQing", nil);
