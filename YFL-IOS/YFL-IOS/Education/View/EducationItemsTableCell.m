...
-(void)initView{
    ...
    self.item1.titleLabel.text = [AppDelegate getURLWithKey:@"LearnTaskTitle"];
    ...
    self.item3.titleLabel.text = [AppDelegate getURLWithKey:@"Yijianfankui"];
    ...
    self.item4.titleLabel.text = [AppDelegate getURLWithKey:@"XuexiXingDe"];
