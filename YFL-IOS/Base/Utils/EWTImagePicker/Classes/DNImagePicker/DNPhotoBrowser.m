...
@property (nonatomic, strong) DNCheckButton *checkButton;
...
//                                 action:@selector(backButtonAction)];
    NAVIGATION_BAR_LEFT_BUTTON(0, 0,20, 20, @"view_back", @"view_back", backButtonAction);
...
#pragma mark - get/set
- (DNCheckButton *)checkButton
{
    if (nil == _checkButton) {
        _checkButton = [DNCheckButton buttonWithType:UIButtonTypeCustom];
        _checkButton.frame = CGRectMake(0, 0, 21, 21);
        [_checkButton setImage:[[UIImage imageWithContentsOfFile:[[NSBundle EWTImagePickerBundle] pathForResource:@"icon_list_checkbox_abled" ofType:@"png"]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateSelected];
        [_checkButton setImage:[[UIImage imageWithContentsOfFile:[[NSBundle EWTImagePickerBundle] pathForResource:@"icon_list_checkbox_disabled" ofType:@"png"]] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] forState:UIControlStateNormal];
