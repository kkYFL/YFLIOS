...
-(void)initView{
    ...
    
    {
        ...
        rouleLabel.text = [AppDelegate getURLWithKey:@"KaoshiGuize"];
    ...
    examTileLab.text = [AppDelegate getURLWithKey:@"kaishikaoshi"];
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    self.title = [AppDelegate getURLWithKey:@"KaoshiGuize"];
}
